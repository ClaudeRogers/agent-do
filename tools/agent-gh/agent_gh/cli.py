...
def _build_release_parser(sub: Any) -> None:
    ...
    redit.add_argument("--draft", action="store_const", const=True)
    redit.add_argument("--no-draft", dest="draft", action="store_const", const=False)
    redit.add_argument("--prerelease", action="store_const", const=True)
    redit.add_argument("--no-prerelease", dest="prerelease", action="store_const", const=False)
    redit.set_defaults(draft=None, prerelease=None)
