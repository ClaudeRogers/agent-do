...
CLAUDE_SETTINGS_SPECS=(
    ...
    "UserPromptSubmit||agent-do-screenshot-capture.sh|5"
...
uninstall() {
    ...
    local hooks=(
        ...
        "agent-do-screenshot-capture.sh"
...
CLAUDE_HOOK_SPECS=(
    ...
    "agent-do-screenshot-capture.sh|hooks/claude/agent-do-screenshot-capture.sh|sh|required"
