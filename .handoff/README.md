...
| ---: | --- | --- | --- | --- |
| 01 | `mn-cbaf37` | in_progress | none | `.handoff/mn-cbaf37-research-audit-landed-stage-0-and-adjudicate-the-missing-provena.md` (held under live claim; expected `.handoff/01-mn-cbaf37-research-audit-landed-stage-0-and-adjudicate-the-missing-provena.md`) |
| 02 | `mn-90b694` | open | none | `.handoff/02-mn-90b694-moon-trunk-a-gh-issue-verbs-create-assign-label-list-close-comme.md` |
| 03 | `mn-807f18` | open | none | `.handoff/03-mn-807f18-moon-trunk-b-manna-floor-claim-policy-gh-issue-metadata-sync-git.md` |
| 04 | `mn-c3145f` | open | none | `.handoff/04-mn-c3145f-moon-trunk-c-agent-do-attest-stamp-verify-doctor.md` |
| 05 | `mn-404dd7` | blocked | `mn-90b694`, `mn-807f18`, `mn-c3145f` | `.handoff/05b04-mn-404dd7-moon-trunk-d-policy-engine-init-show-check-install-org-scoping.md` |
| 06 | `mn-f1604f` | blocked | `mn-404dd7` | `.handoff/06b05-mn-f1604f-moon-trunk-e-ambient-hooks-board-injection-auto-claim-floor-nudg.md` |
| 07 | `mn-54cec0` | blocked | `mn-404dd7`, `mn-f1604f` | `.handoff/07b06-mn-54cec0-moon-trunk-g-vid-adoption-pass-newco-portable-spec-policy-yaml-1.md` |
...
| 29 | `mn-386f70` | in_progress | none | `.handoff/29-mn-386f70-harness-agent-substack-draft-publish-essays-through-substack-s-e.md` |
...
| 32 | `mn-8f9ef3` | blocked | `mn-404dd7` | `.handoff/32b05-mn-8f9ef3-board-view-policy-floor-layer-and-notify-rules-trunk-f-remainder.md` |
