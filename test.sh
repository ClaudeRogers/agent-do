...
check_cmd "gh sync tests" python3 "$SCRIPT_DIR/tests/test_gh_sync.py"
...
check_cmd "gh pr create unit tests" python3 "$SCRIPT_DIR/tools/agent-gh/test/unit/test_pr_create.py"
check_cmd "gh cr unit tests" python3 "$SCRIPT_DIR/tools/agent-gh/test/unit/test_cr.py"
check_cmd "gh refs unit tests" python3 "$SCRIPT_DIR/tools/agent-gh/test/unit/test_refs.py"
check_cmd "gh transport unit tests" python3 "$SCRIPT_DIR/tools/agent-gh/test/unit/test_transport.py"
check_cmd "gh triage unit tests" python3 "$SCRIPT_DIR/tools/agent-gh/test/unit/test_triage.py"
check_cmd "gh release notes unit tests" python3 "$SCRIPT_DIR/tools/agent-gh/test/unit/test_release_notes.py"
